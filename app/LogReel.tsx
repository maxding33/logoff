...
export default function LogReel({
  ...
  return (
    ...
    >
      ...
      {/* Progress dots (text fallback if > 12 posts) */}
      ...
      {/* Close button */}
      <button type="button" onClick={onClose} style={{ position: "fixed", top: "12px", left: "16px", background: "none", border: "none", color: "#fff", fontSize: "28px", cursor: "pointer", lineHeight: 1, zIndex: 10, touchAction: "manipulation", minWidth: "44px", minHeight: "44px", display: "flex", alignItems: "center", justifyContent: "center" }}>×</button>
                  ...
                  <div key={c.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid #f5f5f5" }}>
                    ...
                    {c.userId === currentUserId && (
                      <button
                        ...
                        style={{ background: "none", border: "none", cursor: "pointer", color: "#ccc", fontSize: "18px", padding: "0 0 0 8px", lineHeight: 1, flexShrink: 0, touchAction: "manipulation" }}
                      >×</button>
                    )}
                  </div>
                ))
