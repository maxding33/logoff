...
export default function ProfileContent() {
  ...
  return (
    <main style={{ minHeight: "100%", background: "#fff", paddingBottom: "96px", overflowX: "hidden", touchAction: "pan-y" }}>
      {/* Header */}
      <header style={{
        padding: "0 16px",
        height: "53px",
      ...
      {pageIndex === 1 && <BottomNav fileInputRef={fileInputRef} handlePhotoChange={handlePhotoChange} cameraOnly={!!challengeTimer} />}
